...
- conferences including conference tickets, travel expenses (train and airline tickets, etc.), hotel. **Food/meals are excluded and should be paid for with you personal money.paid Meetups and events**
...
- conference ticket
- Gas (UoP, UZ - kilometrówka, B2B - add to your invoice for HTD)
...
We have ordered Revolut physical debit business cards for all the employees since December 2018. It’s able to use the card both online and at physical locations. Please note that we are not yet sure if Revolut Business will work for us so we might go different route.
...
The budget is reduced by a net amount (i.e. without VAT tax) of your expense. Upload an expense VAT invoice to Revolut Business app with correct data.
For instance, if you pay 1230 PLN (1000 net + 230 PLN VAT) for a conference then we treat it as the cost was 1000 PLN so your education budget is decreased by 1000 PLN. 
...
Please upload an **electronic invoice (.pdf)** to your Revolut Business App.
 
Important: If you have a **paper invoice** or **paragon** then please scan it to pdf and then upload it (one of the apps you can use to scan documents into pdf format is Dropbox, Adobe Scan, Scannable). **Then send** a paper invoice or paragon (both on original paper) to the office address or put it in a mailbox located in the office.
...
- request an unpaid/paid day off in Calamari
